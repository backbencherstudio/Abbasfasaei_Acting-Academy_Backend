/*
  ...
  - The values [MANUAL_ENTRY] on the enum `PaymentGateway` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."PaymentGateway_new" AS ENUM ('STRIPE', 'STRIPE_MANUAL_ENTRY');
